 ...
 * client-side (agent-card.tsx), with each toggle persisted per agent in
 * localStorage (the orchestrator already picks agents per prompt; the
 * toggle is the analyst's roster preference, not a routing switch).
 */
