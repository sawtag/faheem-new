...
/**
 * Deal pipeline board (spec §4 item 4), origin filter pills over a
 * four-column governed flow. Carries the private→public pivot on screen.
 */
export default async function DealsPage() {
  const t = await getTranslations("deals.board");

  return (
    <main className="mx-auto max-w-[1320px] px-8 pt-10 pb-16">
