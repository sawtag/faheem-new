...
- **Target market (enterprise):** investment firms & asset managers, bank research/capital-markets desks, sovereign wealth funds — **name-drop the PIF** (~$900B+, Riyadh; the world's most ambitious sovereign investor) as the aspirational ceiling: "every institution that evaluates deals, from boutique desks to the PIF." Frame as ambition, not a claimed customer.
